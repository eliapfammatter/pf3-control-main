...
class TrajectorySet:
    ...
    Parameters
    ----------
    y_T : Trajectory or None
        Guide vane opening trajectory.
    N_T : Trajectory or None
        Turbine speed trajectory.
    H_ref : Trajectory or None
        Reference head trajectory.
    N_P : Trajectory or None
        Pump speed trajectory. Optional; treated as 0 when absent.
    """

    y_T: Trajectory | None
    N_T: Trajectory | None
    H_ref: Trajectory | None
    N_P: Trajectory | None
...
class Artefact:
    ...
    predictions : dict[str, numpy.ndarray] or None
        Optional model predictions, e.g. from a state estimator.
    """
